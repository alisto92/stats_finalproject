...
```{r}
data2 %>% select(crmrte, west, central, urban) %>% group_by(central) %>% summarise(mean_crmrte = mean(crmrte))

data2 %>% select(crmrte, west, central, urban) %>% group_by(west) %>% summarise(mean_crmrte = mean(crmrte))

data2 %>% select(crmrte, west, central, urban) %>% group_by(urban) %>% summarise(mean_crmrte = mean(crmrte))
```
